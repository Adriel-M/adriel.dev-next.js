...
lastmod: 2024-02-11T04:12:08.152Z
---
...
![](/static/images/2024-02-09-speeding-up-builds-for-berry-yarn-projects-on-vercel/override-install.png)
...
This is what the final script looks like that copies that `install-state.gz`, set the `YARN_CACHE_FOLDER` environment
